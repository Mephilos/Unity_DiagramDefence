...
public class OrbitStrategy : MovementStrategy
{
    ...
    public override Vector3 Move(Transform currentTransform, Transform targetTransform, float speed, ref float rotationTracker)
    {
        ...
        Vector3 directionToTarget = (targetTransform.position - currentTransform.position).normalized;
        ...
        {
            currentTransform.position += directionToTarget * speed * Time.deltaTime;
